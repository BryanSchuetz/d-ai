...
<section class="w-full p-8 max-w-2xl m-auto">
  ...
  {:else}
      ...
      <div class="spinner max-w-md m-auto items-center">
        ...
        <h2 class="text-center">One moment, your prompt is being used to query <a target="_blank" rel="noreferrer" class="text-blue-500 hover:text-blue-700" href="https://www.pinecone.io/learn/vector-embeddings/">a vector database</a> of DAI primary sources. A collection of near sources will be returned for use by the OpenAI model when generating your text.</h2>
      </div>
  {/if}
</section>
